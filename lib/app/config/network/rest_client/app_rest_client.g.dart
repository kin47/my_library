...
class _AppRestClient implements AppRestClient {
  ...
  @override
  Future<BookResponse> getOneBook(int id) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<HomeAdminResponse> getAdminStatistical() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HomeUserResponse> getUserStatistical() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<HomeUserResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = HomeUserResponse.fromJson(_result.data!);
    return value;
  }
